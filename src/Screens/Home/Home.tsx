        ...
        <div>
            ...
            <header id="header">
                <div className="d-flex flex-column">
                    ...
                    <div className="profile">
                        ...
                        <h1 className="text-light"><a href="index.html">Dinithi Samindani</a></h1>
            ...
            <section id="hero" className="d-flex flex-column justify-content-center align-items-center">
                <div className="hero-container" data-aos="fade-in">
                    <h1>Dinithi Samindani</h1>
                    <p>I'm <span className="typed" data-typed-items="Business Analyst"></span></p>
                </div>
            </section>
                ...
                <section id="about" className="about">
                    <div className="container">
                        ...
                        <div className="section-title">
                            <h2>About</h2>
                            <p>A passionate and enthusiastic individual with good
                                interpersonal and communication skills along with the
                                ability to build effective relationships among co-workers
                                and clients while managing the projects from the concept
                                unto the completion.</p>
                        </div>
                            ...
                            <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <ul>
                                            <li><i className="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Bsc (Hons) in Information Technology and Management</span></li>
                                        </ul>
                                    </div>
                                    <div className="col-lg-6">
                                        <ul>
                                            <li><i className="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>15 Dec 1997</span></li>
                                            <li><i className="bi bi-chevron-right"></i> <strong>Phone:</strong> <span> 0717211257 / 0788067416</span></li>
                                            <li><i className="bi bi-chevron-right"></i> <strong>Address:</strong> <span>No. 5D, Sumedha Mawatha,Ganemulla</span></li>
                                            <li><i className="bi bi-chevron-right"></i> <strong>Website:</strong> <span>dinithisamindanipriyashiroma.web.app</span></li>
                                            <li><i className="bi bi-chevron-right"></i> <strong>Email:</strong> <span>dinithisamindani@gmail.com</span></li>
                                        </ul>
                                    </div>
                                    <div className="col-lg-6">
                                        <ul>
                        ...
                        <div className="row">
                            <div className="col-lg-6" data-aos="fade-up">
                                ...
                                <div className="resume-item pb-0">
                                    <h4>Dinithi Samindani</h4>
                                    <p><em>A passionate and enthusiastic individual with good
                                        interpersonal and communication skills along with the
                                        ability to build effective relationships among co-workers
                                        and clients while managing the projects from the concept
                                        unto the completion.
                                    ...
                                    <ul>
                                        <li>No. 5D, Sumedha Mawatha,Ganemulla</li>
                                        <li>0717211257 / 0788067416</li>
                                        <li>dinithisamindani@gmail.com</li>
                                    </ul>
                                </div>

                                <h3 className="resume-title">Education</h3>
                                <div className="resume-item">
                                    <h4>Bsc (Hons) in Information Technology and Management</h4><br/>
                                    <h5>2017 - Present (Expected in 2021)</h5><br/>
                                    <br/><p><em>University of Moratuwa - Faculty of Information Technology</em></p><br/>
                                    <p><em>Current GPA - 3.22</em></p><br/>
                                    {/* <p>Qui deserunt veniam. Et sed aliquam labore tempore sed quisquam iusto autem sit. Ea vero voluptatum qui ut dignissimos deleniti nerada porti sand markend</p> */}
                                </div>
                                <div className="resume-item">
                                    <h4>B.A in English (General) External Degree</h4><br/>
                                    <h5>2018 - Present (Expected in 2022)</h5><br/>
                                    <br/><p><em>University of Sri Jayewardenepura</em></p><br/>
                                    {/* <p>Quia nobis sequi est occaecati aut. Repudiandae et iusto quae reiciendis et quis Eius vel ratione eius unde vitae rerum voluptates asperiores voluptatem Earum molestiae consequatur neque etlon sader mart dila</p> */}
                                </div>
                                <div className="resume-item">
                                    <h4>Diploma in Translation and Interpretation</h4><br/>
                                    <h5>2017</h5><br/>
                                    <br/><p><em>University of Kelaniya</em></p><br/>
                                    {/* <p>Quia nobis sequi est occaecati aut. Repudiandae et iusto quae reiciendis et quis Eius vel ratione eius unde vitae rerum voluptates asperiores voluptatem Earum molestiae consequatur neque etlon sader mart dila</p> */}
                                </div>
                            </div>
                            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div className="resume-item">
                                    <h4>Associate Business Analyst.</h4>
                                    <h5>May 2021 - Present (Part time)</h5>
                                    <p><em>Agrithmics (Pvt) Ltd</em></p>
                                    <ul>
